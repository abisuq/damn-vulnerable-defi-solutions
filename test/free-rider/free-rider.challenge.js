...
describe('[Challenge] Free Rider', function () {
  ...
  before(async function () {
    ...
    this.uniswapPair = await UniswapPairFactory.attach(await this.uniswapFactory.getPair(this.token.address, this.weth.address))
    ...
    await this.marketplace.offerMany([0, 1, 2, 3, 4, 5], [NFT_PRICE, NFT_PRICE, NFT_PRICE, NFT_PRICE, NFT_PRICE, NFT_PRICE])
  ...
  it('Exploit', async function () {
    ...
    const Contract = await ethers.getContractFactory('FreeRiderAttack', deployer)
